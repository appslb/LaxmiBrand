package com.e.laxmibrand.utils;
...
/*
import com.app.sradesign.MyApplication;
import com.app.sradesign.PreferenceSettings;
import com.app.sradesign.R;
import com.app.sradesign.activity.LoginActivity;
import com.app.sradesign.retrofit.RetroInterface;
import com.app.sradesign.retrofit.RetrofitAdapter;
*/

import com.e.laxmibrand.MyApplication;
import com.e.laxmibrand.PreferenceSettings;
import com.e.laxmibrand.R;
import com.e.laxmibrand.retrofit.RetroInterface;
import com.e.laxmibrand.retrofit.RetrofitAdapter;
...
public class Utility {
    ...
    public static int superadmin_role_id = 1;
    public static int admin_role_id = 2;
    public static int user_role_id = 3;
    public static String new_arrival_catalogue = "new_arrival";
    public static String recommended_catalogue = "recommended";
    public static String other_catalogue = "other";
    public static String recent_update_catalogue = "recent_update";
    public static String trending_catalogue = "trending";
    public static int noti_type_order = 1;
    public static int noti_type_user = 2;
    public static int noti_type_general = 3;
...
//        sha = "F6:AE:11:2B:EE:46:B4:C6:58:98:35:F6:8D:B6:9B:84:39:CC:EF:93";
 ...
 public static boolean isOnline(Context mContext) {
    ...
    public static void noInternetError(final Context context) {
        ...
        builder1.setIcon(R.drawable.logo1);
