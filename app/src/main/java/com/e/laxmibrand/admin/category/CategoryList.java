package com.e.laxmibrand.admin.category;
                        ...
                        if (!catName.getText().toString().trim().isEmpty()) {
                            if (Utility.isOnline(v.getContext())) {
                              /*  catObject = new JsonObject();
                                catObject.addProperty("category_name", catName.getText().toString().trim());
                                catObject.addProperty("is_active", "1");
*/
...
addCategoryBtn.setText("Add Category");
    ...
    private MultipartBody.Part prepareFilePart(String partName) {
      ...
      catimageFile=null;
        if(imageUri!=null) {
            File imgFile = new File(ImageFilePath.getPath(CategoryList.this, imageUri));
            try {
    ...
    private void addNewCategory() {
        ...
        MultipartBody.Part catimage = prepareFilePart("image[]");
