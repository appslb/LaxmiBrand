...
*/
        ...
        viewHolder.variantText.setText(variantStr);
            viewHolder.priceText.setText("Rs. " + productList.get(i).getVarientItems().get(0).getVarActualAmt() + " per " + productList.get(i).getVarientItems().get(0).getVarType());
        ...
        if(productList.get(i).getIs_active().equals("1"))
            viewHolder.displayToUser.setVisibility(View.VISIBLE);
        else
            viewHolder.displayToUser.setVisibility(View.GONE);
