...
public class AdminOrderFragment extends AppCompatActivity {
   ...
   public static ArrayList<Orders> orderList;
    ...
    //    ArrayList<OrderModel.OrderCatalogue> catalog1, catalog2, catalog3, catalog4;
  ...
  //  ArrayList<GetAllOrderDetailResponse.ResponseData> orderList;
    int orderid = 0;
   ...
   */
   ...
   protected void onCreate(Bundle savedInstanceState) {
      ...
      //  searchFnameET = findViewById(R.id.searchFnameET);
