...
public class UserCartItem {
     ...
     String pdt_id,var_id,category,productname,productImage,variant,actual_price,savedAmount,total_price,var_dis;
int qty;

    public UserCartItem(String category,String var_id,String pdt_id,String productname,String productImage,int qty,String variant,String actual_price,String var_dis,String savedAmount,String total_price){
         this.pdt_id = pdt_id;
    ...
    public void setVar_dis(String var_dis){this.var_dis=var_dis;}
    public String getVar_dis(){return var_dis;}
